...
# Declare the function to call for d3_blue scraping.
def scrape(CHROME_FLUSH_AFTER_CYCLES, PING_AFTER_AMOUNT_OF_CYCLES, scrapescounter, us_full_page_d3, eu_full_page_d3):
...
if __name__ == "__main__":
    ...
    while True:
        ...
        scrape(CHROME_FLUSH_AFTER_CYCLES, PING_AFTER_AMOUNT_OF_CYCLES, scrapescounter, us_full_page_d3, eu_full_page_d3)
